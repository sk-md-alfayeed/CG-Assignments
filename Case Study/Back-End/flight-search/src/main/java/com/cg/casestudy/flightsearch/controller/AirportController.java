...
import com.cg.casestudy.flightsearch.service.AirportService;
...
public class AirportController {
	...
	// Getting REST GET request and returning 'all flights list' from AirportService
	@GetMapping(value = "/allAirports")
	public List<Airport> getAllAirports() {
		return airportService.getAllAirports();
	}

	// Getting REST GET request and returning 'one flight' from AirportService
